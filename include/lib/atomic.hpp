...
{
    return memory_order(cmpexch_failure_order2(m & __memory_order_mask) | (m & __memory_order_modifier_mask));
}
...
struct atomic_bool {
  ...
  public:
    ...
    bool compare_exchange_weak(bool& i1, bool i2,
        memory_order m = memory_order_seq_cst) noexcept
    {
    ...
    bool compare_exchange_strong(bool& i1, bool i2,
        memory_order m = memory_order_seq_cst) noexcept
    {
...
struct atomic {
  ...
  public:
    ...
    bool compare_exchange_weak(T& e, T i,
        memory_order m = memory_order_seq_cst) noexcept
    {
    ...
    bool compare_exchange_strong(T& e, T i,
        memory_order m = memory_order_seq_cst) noexcept
    {
